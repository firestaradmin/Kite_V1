...
echo "========================================================================="
echo "@_@ 自动添加提交commit当前分支并推送到远端仓库 之 懒人の脚本"
...
judge_status=$(git status | grep 'nothing to commit, working tree clean')
# echo "$judges"
