...
#include "esp_log.h"
static const char* TAG = "LCD_ST7789_190_WLK";

#if 1
#define _VENDOR "WoLeKang"
...
DRAM_ATTR static LcdInitCmdSeq _lcd_init_cmds[] = {
    ...
    {0xE0, {0xF0,0x19,0x1C,0x0C,0x0B,0x07,0x35,0x33,0x4A,0x37,0x13,0x12,0x2E,0x34}, 14},

    /* Negative Voltage Gamma Control */
    {0xE1, {0xF0,0x16,0x1A,0x07,0x05,0x20,0x35,0x32,0x49,0x38,0x15,0x16,0x2F,0x35}, 14},
    /* Sleep Out */
    {0x21, {0}, 0x80},
    /* Display On */
    {0x29, {0}, 0x80},
...
void lcd_init_st7789_190_wlk(LcdConfigure *config, LcdDevice *dev_dest)
{
